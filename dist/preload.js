...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    refreshCurrentUser: () => ipcRenderer.invoke('refreshCurrentUser'),
    getDeviceBinding: () => ipcRenderer.invoke('getDeviceBinding'),
    getPosDisplayName: () => ipcRenderer.invoke('getPosDisplayName'),
    resetDeviceBinding: (payload) => ipcRenderer.invoke('resetDeviceBinding', payload),
    ...
    getOfflineRestaurantOps: () => ipcRenderer.invoke('getOfflineRestaurantOps'),
    syncOfflineRestaurantOps: () => ipcRenderer.invoke('syncOfflineRestaurantOps'),
    cancelSyncOfflineRestaurantOps: () => ipcRenderer.invoke('cancelSyncOfflineRestaurantOps'),
    retryOfflineRestaurantOp: (operationId) => ipcRenderer.invoke('retryOfflineRestaurantOp', operationId),
    dismissOfflineRestaurantOp: (operationId) => ipcRenderer.invoke('dismissOfflineRestaurantOp', operationId),
    getShiftStatus: () => ipcRenderer.invoke('getShiftStatus'),
    openShift: (payload) => ipcRenderer.invoke('openShift', payload),
    closeShift: (payload) => ipcRenderer.invoke('closeShift', payload),
    getOfflineShiftOps: () => ipcRenderer.invoke('getOfflineShiftOps'),
    syncOfflineShiftOps: () => ipcRenderer.invoke('syncOfflineShiftOps'),
    ...
    onRestaurantOrderEvent: (callback) => {
    ...
    createBomIngredientProduct: (data) => ipcRenderer.invoke('createBomIngredientProduct', data),
    ...
    getRestaurantActivity: (filters) => ipcRenderer.invoke('getRestaurantActivity', filters),
