...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  retryOfflineRestaurantOp: (operationId: string) => ipcRenderer.invoke('retryOfflineRestaurantOp', operationId),
  dismissOfflineRestaurantOp: (operationId: string) => ipcRenderer.invoke('dismissOfflineRestaurantOp', operationId),
  getShiftStatus: () => ipcRenderer.invoke('getShiftStatus'),
  openShift: (payload: { openingCash: number; openedBy?: string }) => ipcRenderer.invoke('openShift', payload),
  closeShift: (payload: { closingCash: number; notes?: string }) => ipcRenderer.invoke('closeShift', payload),
  ...
  createBomIngredientProduct: (data: { name: string; cost: number; unit: string; stock?: number }) =>
    ipcRenderer.invoke('createBomIngredientProduct', data),
